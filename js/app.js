(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        const itemArea = document.querySelectorAll(".card__inner-pic");
 //!комірка зі слайдом
                const showMoreBtn = document.querySelector(".block-desk__button-view-more");
 ...
 //! внутрішня обготка зі слайдами без урахування зовнішньої обгортки в якій знаходитьс //#кнопка для розгортання
        ...
        function toggleItems() {
            ...
            if (itemsShown >= itemArea.length) showMoreBtn.textContent = "Collapse"; else showMoreBtn.textContent = "Load More";
        }
